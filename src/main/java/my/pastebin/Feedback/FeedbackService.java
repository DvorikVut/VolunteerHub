...
public class FeedbackService {
    ...
    public void deleteFeedback(Long id) {
        ...
        userService.calculatePointsAsCreatorAfterDelete(feedback);
    ...
    public List<Feedback> getAllByEventIdRaw(Long eventId) {
        return feedbackRepo.findAllByEventId(eventId);
    }
    ...
    public Integer getQuantityOfFeedbacks(User user) {
        return feedbackRepo.findFeedbacksByEventCreatorId(user.getId()).size();
    }

    public List<FeedbackInfoDTO> getAllByTargetId(Long targetId) {
       return feedbackRepo.findFeedbacksByEventCreatorId(targetId)
               .stream()
               .map(feedbackInfoDTOMapper)
               .collect(Collectors.toList());
    }
